...
if(isset($_GET['Islem']) && $_GET['Islem'] == "Tamamla"){
     $siparisToplamUrun = sepetToplamUrun();
   $siparisUyeID = $_SESSION['UyeID'];

    $siparisToplamFiyat = toplamFiyatHesapla($_SESSION['sepet']);
    $siparisOdeme=0;
    $siparisSepetCode = $_SESSION['sepetcode'];
    
   $siparisDurum = siparisOlustur($siparisSepetCode, $siparisuyeID, $siparisToplamUrun, $siparisToplamFiyat,  $siparisOdeme);
   
   if($siparisDurum!=0){
     //  echo "Sipariş Başarılı";
          sepetYokEt();
...
<div id="wrapper" class="w1180 center mTop20">
    ...
    <section class="w1180 mh500 fleft">
        <div id="content" class="mh500 fleft w1000">
            ...
            <h1>Sipariş Özeti</h1>
            <?php $uyeGirisDurum = uyeGirisVarmi();?>
            
            <?php if(!$uyeGirisDurum){
                echo "Lütfen Üye Girişi Yapınız";
            }else{
                $kullaniciAdi = $_SESSION['KullaniciAdi'];
                echo "Sayın Üyemiz $kullaniciAdi sipariş vermeye bir adım kaldı";
                echo " <a href='siparis-tamamla.php?Islem=Tamamla'>Sipariş Sonlardır</a>";
            }
    ...
    if($sepetDurum==FALSE){
                ...
                if(isset($_SESSION['sepet']) && !empty($_SESSION['sepet'])){
                    ...
                    do{
                        ...
                        $toplamFiyat = toplamFiyatHesapla($_SESSION['sepet']);
                        ...
                        echo "<div class='sepetUrunResim'><img src='_uploads/resim/urun/$row_rsSepetUrun->UrunResim' width='50' height='50'></div>";
                                           echo "<div class='sepetUrunAdi'>$row_rsSepetUrun->UrunAdi</div>";
                                                echo "<div class='sepetUrunMiktar'>$sepetUrunID </div>";
