...
if(isset($_GET['Islem'])){
    $query = "DELETE * FROM urun_profil WHERE UrunProfilID = '$urunProfilID'";
    mysql_query($query);
    
    header("Location:index.php?Islem=UrunProfilSil");
}
?>
<!DOCTYPE html>
<html>
...
<section>
    ...
    <h1>Ürün Profil Silme</h1>
    <p><a href="sil.php?Islem=Sil&UrunProfilID=<?= $urunProfilID;?>">Silmeyi Onaylıyorum</a></p>
</section>
