...
$rsUye = "SELECT uye_giris.UyeID, uye_seviye.SeviyeIcon, uye_seviye.Seviye, uye_giris.KullaniciAdi, uye_giris.Eposta, uye_giris.KayitIP, uye_giris.Aktif, uye_giris.KayitTarih"
        . " FROM uye_giris INNER JOIN uye_seviye ON uye_giris.SeviyeID = uye_seviye.SeviyeID WHERE uye_giris.Aktif !=1 ORDER BY uye_giris.UyeID DESC";
...
<section>
    ...
    <h1>Üyeler</h1>
       <p>Toplam Arşiv Sayısı <?=$num_row_rsUye?></p>
