...
<section>
    ...
    <?php 
   echo "Kdv Tipi Sayısı : $num_row_rsKdv";
   ?>
    <table>
        <tr>
            <th>KDV Tipi</th>
        ...
        <?php do{ ?>
        <tr>
            <td><?= $row_rsKdv->KdvTip; ?> Oran</td>
            <td><?= $row_rsKdv->Kdv; ?></td>
            <td>
                <a href="duzenle.php?KdvID=<?= $row_rsKdv->KdvID;?>">Düzenle</a>
                              | 
                  <a href="sil.php?KdvID=<?= $row_rsKdv->KdvID;?>">Sil</a>   
            </td>
        </tr>
