...
//ürün harfleri kayıt setlerinin oluşturulması
$query_rsUrunHarf = "SELECT * FROM urun_harf ORDER BY HarfID ASC";
...
$( "#tabs" ).tabs();
    ...
    <style>
         ...
         #HarfBox a:link, #HarfBox a:visited{
                 color:#666;
         font-weight: bold;
         font-size: 1em;
         padding:5px;
...
<section>
    ...
    <div id="HarfBox">
        <?php do{ ?>
        <a href="duzenle.php?HarfID=<?= $row_rsUrunHarf->HarfID?>"><?= $row_rsUrunHarf->Harf;?></a>
