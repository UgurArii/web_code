...
$query_rsGosterimTuru = "SELECT * FROM urun_gosterim_turu";
$rsGosterimTuru = mysql_query($query_rsGosterimTuru);
$row_rsGosterimTuru = mysql_fetch_object($rsGosterimTuru);
$num_row_rsGosterimTuru = mysql_num_rows($rsGosterimTuru);
...
<section>
    ...
    <?php
    echo "Gösterim Türü Sayısı : $num_row_rsGosterimTuru";
    ?>
    ...
    <table>
        ...
        <?php do{ ?>
        <tr>
            <td><?= $row_rsGosterimTuru->GosterimTuru;?></td>
            <td>
                <a href="duzenle.php?GosterimTuruID=<?= $row_rsGosterimTuru->GosterimTuruID;?>">Düzenle</a>
                <a href="sil.php?GosterimTuruID=<?= $row_rsGosterimTuru->GosterimTuruID;?>">Sil</a>
            </td>
        </tr>
        <?php }while($row_rsGosterimTuru = mysql_fetch_object($rsGosterimTuru));?>
