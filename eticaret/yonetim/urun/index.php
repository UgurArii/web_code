...
function urun_profil_varmi($urunID){
    ...
    $num_row = mysql_fetch_object($result);
    return $num_row;
}
...
$("tr.urun:even").addClass("ciftSatir");
$("tr.urun:odd").addClass("tekSatir");
...
<section>
   ...
   echo "<p>Kayıtlı Ürün Sayısı $num_row_rsUrun</p>";
    ?>
     <p><a href="ekle.php" >Ürün Ekle</a>   |   <a href="arsiv.php">Arşiv Göster</a> | <a href="index-profil.php">Profili Olanları Göster</a></p>
    <table id="dinamikListe">
        ...
        <tr class="urun">
            ...
            <td width="325" class="buton">
                ...
                <a href="../urun_resim/ekle.php?UrunID=<?= $row_rsUrun->UrunID ;?>">Resim Ekle</a> 
                <?php if(urunResimSayisi($urunID->UrunID)>0) :?>
                <a href="../urun_resim/index.php?UrunID=<?= $row_rsUrun->UrunID ;?>">Resim Düzenle</a> 
                  <?php endIf;?>
                <?php endIf;?>
